 ...
 *                                                                                                                    *
 * Project : dashboard                                                                                                *
 * File : es-module-shims.js                                                                                          *
 *                                                                                                                    *
 * @author: Christian Denat                                                                                           *
 * @email: contact@noleam.fr                                                                                          *
 *                                                                                                                    *
 * Last updated on : 14/07/2023  15:33                                                                                *
 *                                                                                                                    *
...
(function () {
    ...
    if (!n) if (document.querySelectorAll("script[type=module-shim],script[type=importmap-shim],link[rel=modulepreload-shim]").length) n = true; else {
        let e = false;
        for (const t of document.querySelectorAll("script[type=module],script[type=importmap]")) if (e) {
    ...
    function resolveIfNotPlainOrUrl(e, t) {
        ...
        if ("." === e[0] && ("/" === e[1] || "." === e[1] && ("/" === e[2] || 2 === e.length && (e += "/")) || 1 === e.length && (e += "/")) || "/" === e[0]) {
            ...
            let s;
            if ("/" === t[r.length + 1]) if ("file:" !== r) {
                s = t.slice(r.length + 2);
                s = s.slice(s.indexOf("/") + 1)
            } else s = t.slice(8); else s = t.slice(r.length + ("/" === t[r.length]));
            if ("/" === e[0]) return t.slice(0, t.length - s.length - 1) + e;
            const n = s.slice(0, s.lastIndexOf("/") + 1) + e;
            const a = [];
            let i = -1;
            for (let e = 0; e < n.length; e++) if (-1 === i) {
                if ("." === n[e]) {
    ...
    function resolveAndComposeImportMap(e, t, r) {
        ...
        if (e.scopes) for (let n in e.scopes) {
    ...
    function parse(e, t = "@") {
        ...
        if (r > Te || !Me) {
            ...
            je = new ArrayBuffer(Te), _e(Ne, new Uint16Array(je, 16, 105)), Me = function (e, t, r) {
                "use asm";
                var s = new e.Int8Array(r), n = new e.Int16Array(r), a = new e.Int32Array(r), i = new e.Uint8Array(r),
                    c = new e.Uint16Array(r), f = 1024;

                function b() {
                    var e = 0, t = 0, r = 0, i = 0, ne = 0, oe = 0, ce = 0;
                    ce = f;
                    f = f + 10240 | 0;
                    s[795] = 1;
                    n[395] = 0;
                                                ...
                                                default: {
                                                    ...
                                                    r:do {
                                                        if (!(U(i) | 0)) {
                                                            ...
                                                            t = a[68] | 0;
                                                            r = c[396] | 0;
                                                            if (!(p(a[t + (r << 3) + 4 >> 2] | 0) | 0) ? (a[t + (r << 3) >> 2] | 0) != 6 : 0) ne = 66; else ne = 69
                                                        } else switch (i << 16 >> 16) {
                                                            case 46:
                ...
                function l() {
                    var e = 0, t = 0, r = 0, i = 0, c = 0, f = 0, ne = 0, oe = 0, ce = 0, le = 0, fe = 0, ue = 0,
                        de = 0, pe = 0;
                    oe = a[70] | 0;
                    ce = a[63] | 0;
                    pe = oe + 12 | 0;
                ...
                function k() {
                    ...
                    e:do {
                        switch ((w(1) | 0) << 16 >> 16) {
                            ...
                            default:
                                if ((a[70] | 0) == (e | 0)) a[70] = c + 10; else i = 18
                        }
                    } while (0);
                    do {
                        if ((i | 0) == 18) {
                ...
                function w(e) {
                    ...
                    e:do {
                        t = n[r >> 1] | 0;
                        t:do {
                            if (t << 16 >> 16 != 47) if (e) if (V(t) | 0) break; else break e; else if (F(t) | 0) break; else break e; else switch (n[r + 2 >> 1] | 0) {
                                case 47: {
                                    P();
                                    break t
                                }
                ...
                function A(e, t, r, n) {
                    ...
                    a[61] = i;
                    a[i + 8 >> 2] = e;
                    if (2 == (n | 0)) e = r; else e = 1 == (n | 0) ? r + 2 | 0 : 0;
                    a[i + 12 >> 2] = e;
                    a[i >> 2] = t;
                    a[i + 4 >> 2] = r;
                    a[i + 16 >> 2] = 0;
                ...
                function x(e) {
                    ...
                    e:do {
                        if ((t + -9 & 65535) >= 5) {
                            ...
                            if (I(t) | 0) return t << 16 >> 16 != 46 | (G(e) | 0) | 0; else t = 0
                        } else t = 1
                    } while (0);
                    return t | 0
                }
                ...
                function O(e, t, r) {
                    ...
                    n = s + 2 | 0;
                    e = a[3] | 0;
                    if (n >>> 0 >= e >>> 0 ? (m(n, t, r << 1) | 0) == 0 : 0) if ((n | 0) == (e | 0)) e = 1; else e = x(s) | 0; else e = 0;
                    return e | 0
                }
                ...
                function j(e) {
                    ...
                    switch (n[e >> 1] | 0) {
                        ...
                        case 101: {
                            if ((n[e + -2 >> 1] | 0) == 117) e = O(e + -4 | 0, 106, 6) | 0; else e = 0;
                            break
                        }
                        default:
                            e = 0
                ...
                function B(e, t) {
                    ...
                    var r = 0;
                    r = a[3] | 0;
                    if (r >>> 0 <= e >>> 0 ? (n[e >> 1] | 0) == t << 16 >> 16 : 0) if ((r | 0) == (e | 0)) r = 1; else r = E(n[e + -2 >> 1] | 0) | 0; else r = 0;
                    return r | 0
                }
                ...
                function G(e) {
                    e = e | 0;
                    if ((n[e >> 1] | 0) == 46 ? (n[e + -2 >> 1] | 0) == 46 : 0) e = (n[e + -4 >> 1] | 0) == 46; else e = 0;
                    return e | 0
                }

                function H(e) {
                    e = e | 0;
                    if ((a[3] | 0) == (e | 0)) e = 1; else e = x(e + -2 | 0) | 0;
                    return e | 0
                }
        ...
        const n = [], a = [];
        for (; Me.ri();) {
            const e = Me.is(), t = Me.ie(), r = Me.ai(), s = Me.id(), a = Me.ss(), i = Me.se();
            let c;
        ...
        for (; Me.re();) {
            const e = Me.es(), t = Me.ee(), r = Me.els(), s = Me.ele(), n = He.charCodeAt(e),
    ...
    function l() {
        ...
        switch (++Fe, e) {
            ...
            default:
                if (e >= 48 && e <= 55) {
                    let t = He.substr(Fe - 1, 3).match(/^[0-7]+/)[0], r = parseInt(t, 8);
    ...
    function k(e) {
        ...
        for (let t = 0; t < e; ++t, ++Fe) {
            ...
            if (95 !== n) {
                if (n >= 97) e = n - 97 + 10; else if (n >= 65) e = n - 65 + 10; else {
                    if (!(n >= 48 && n <= 57)) break;
                    e = n - 48
                }
                if (e >= 16) break;
    ...
    async function _resolve(e, t) {
        ...
        return {r: resolveImportMap(De, r || e, t) || throwUnresolved(e, t), b: !r && !isURL(e)}
    }

    const Je = i ? async (e, t) => {
        let r = i(e, t, defaultResolve);
        r && r.then && (r = await r);
        return r ? {r: r, b: !resolveIfNotPlainOrUrl(e, t) && !isURL(e)} : _resolve(e, t)
    } : _resolve;
    ...
    async function importShim(e, ...r) {
        ...
        await ze;
        return topLevelLoad((await Je(e, s)).r, {credentials: "same-origin"})
    }
        ...
        if (t) {
            ...
            if (n || !We) {
                new MutationObserver((e => {
                    for (const t of e) if ("childList" === t.type) for (const e of t.addedNodes) if ("SCRIPT" === e.tagName) {
                ...
                if ("complete" === document.readyState) readyStateCompleteCheck(); else {
    ...
    function resolveDeps(e, t) {
        ...
        for (const {s: t, ss: s, se: oe, d: ce} of r) if (-1 === ce) {
            let r = e.d[c++], s = r.b, f = !s;
            f && ((s = r.s) || (s = r.s = createBlob(`export function u$_(m){${r.a[1].map((({s: e, e: t}, s) => {
                const n = '"' === r.S[e] || "'" === r.S[e];
                return `e$_${s}=m${n ? "[" : "."}${r.S.slice(e, t)}${n ? "]" : ""}`
            })).join(",")}}${r.a[1].length ? `let ${r.a[1].map(((e, t) => `e$_${t}`)).join(",")};` : ""}export {${r.a[1].map((({
                                                                                                                                   s: e,
                                                                                                                                   e: t
                                                                                                                               }, s) => `e$_${s} as ${r.S.slice(e, t)}`)).join(",")}}\n//# sourceURL=${r.r}?cycle`)));
            pushStringTo(t - 1);
        ...
        e.s && (a += `\n;import{u$_}from'${e.s}';try{u$_({${s.filter((e => e.ln)).map((({
                                                                                            s: e,
                                                                                            e: t,
                                                                                            ln: r
                                                                                        }) => `${n.slice(e, t)}:${r}`)).join(",")}})}catch(_){};\n`);
    ...
    const et = /^(text|application)\/json(;|$)/;
    const tt = /^(text|application)\/css(;|$)/;
    const rt = /url\(\s*(?:(["'])((?:\\.|[^\n\\"'])+)\1|((?:\\.|[^\s,"'()\\])+))\s*\)/g;
    let st = [];
    let nt = 0;

    function pushFetchPool() {
        if (++nt > 100) return new Promise((e => st.push(e)))
    }
    ...
    async function fetchModule(e, t, r) {
        ...
        if (Ye.test(n)) return {r: s.url, s: await s.text(), t: "js"};
        if (et.test(n)) return {r: s.url, s: `export default ${await s.text()}`, t: "json"};
        if (tt.test(n)) return {
            r: s.url,
            s: `var s=new CSSStyleSheet();s.replaceSync(${JSON.stringify((await s.text()).replace(rt, ((t, r = "", s, n) => `url(${r}${resolveUrl(s || n, e)}${r})`)))});export default s;`,
            t: "css"
        };
    ...
    function getOrCreateLoad(e, t, r, s) {
        ...
        a.f = (async () => {
            if (!s) {
                let i;
                ({r: a.r, s: s, t: i} = await (ct[e] || fetchModule(e, t, r)));
                if (i && !n) {
                    if ("css" === i && !he || "json" === i && !be) throw Error(`${i}-modules require <script type="esms-options">{ "polyfillEnable": ["${i}-modules"] }<\/script>`);
    ...
    function processScriptsAndPreloads(e = false) {
        if (!e) for (const e of document.querySelectorAll(n ? "link[rel=modulepreload-shim]" : "link[rel=modulepreload]")) processPreload(e);
        for (const e of document.querySelectorAll(n ? "script[type=importmap-shim]" : "script[type=importmap]")) processImportMap(e);
        if (!e) for (const e of document.querySelectorAll(n ? "script[type=module-shim]" : "script[type=module]")) processScript(e)
    }
    ...
    function domContentLoadedCheck() {
        0 !== --it || ue || !n && We || document.dispatchEvent(new Event("DOMContentLoaded"))
    }
    ...
    function readyStateCompleteCheck() {
        0 !== --ot || ue || !n && We || document.dispatchEvent(new Event("readystatechange"))
    }
    ...
    function processImportMap(e, t = ot > 0) {
        if (!epCheck(e, t)) {
            if (e.src) {
                if (!n) return;
    ...
    function processScript(e, t = ot > 0) {
        if (epCheck(e, t)) return;
        const r = null === e.getAttribute("async") && ot > 0;
        const s = it > 0;
        r && ot++;
        s && it++;
        const a = topLevelLoad(e.src || ke, getFetchOpts(e), !e.src && e.innerHTML, !n, r && at).then((() => {
            n && e.dispatchEvent(new Event("load"))
        })).catch(throwError);
        r && (at = a.then(readyStateCompleteCheck));
    ...
    function processPreload(e) {
        if (!e.ep) {
            e.ep = true;
            ct[e.href] || (ct[e.href] = fetchModule(e.href, getFetchOpts(e)))
        }
    }
})();
