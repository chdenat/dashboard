<?php
	...
	class AssetsManager {
		 ...
		 * @since   1.0
		 */
		public function add_to_css_list( string $handle, string $file, array $deps = [], $type = PAGE )
		: void {
			/**
		 ...
		 * @since  1.0
		 */
		public function add_inline_css( string $handle, string $content, array $deps )
		: void {
			/**
			 * CSS could be already hooked by another register call.
			 * In this case we print the tag directly.
		 ...
		 *
		 */
		public function print_all_css_assets()
		: string|bool {
		 ...
		 * @since  1.0
		 */
		private function print_css_tag( string $handle, Asset $asset )
		: bool|string {
			ob_start();
		 ...
		 * @since  1.0
		 */
		private function _beautify_url( string $url )
		: ?string {
		 ...
		 *
		 */
		private function print_css_tag_direct( string $handle )
		: void {
		 ...
		 *
		 */
		public function print_css_asset( string $file )
		: void {
			ob_start();
			?>
		 ...
		 *
		 */
		public function remove_from_js_list( string $handle, bool $footer = true )
		: ?Asset {
			$asset = null;
			if ( $footer ) {
		 ...
		 * @since  1.0
		 */
		private function _add_to_js_list( Asset $asset )
		: void {
			if ( $asset->in_footer() ) {
		 ...
		 *
		 */
		public function print_all_js_assets( bool $footer = true )
		: string|bool {
		 ...
		 * @since   1.0
		 */
		private function print_js_tag( string $handle, Asset $asset )
		: bool|string {
			ob_start();
			switch ( $asset->get_type() ) {
				case Asset::FILE:
		 ...
		 *
		 */
		public function print_all_js_assets_header()
		: string|bool {
		 ...
		 *
		 */
		public function print_all_js_assets_footer()
		: string|bool {
		 ...
		 * @since  1.0
		 */
		private function sort_by_dependencies( array $assets )
		: array {
		 ...
		 * @since   1.0
		 */
		public function locate_template_assets( string $template, string $type = PAGE )
		: bool|array {
