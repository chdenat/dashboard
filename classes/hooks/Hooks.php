 ...
 **********************************************************************************************************************/
	...
	/**
	 * From http://bainternet.github.io/PHP-Hooks/
	 */
	...
	class Hooks {
		 ...
		 *
		 * @return \dashboard\hooks\Hooks
		 *
		 * @since  0.2
		 */
		public static function instance( array $args = null )
		: Hooks {
		 ...
		 *                                     with a particular action are executed (default: 10). Lower numbers
		 ...
		 *                              object reference, we return the unique id only if it already has one, false
		 *                              otherwise.
		 *
