 ...
 *                                                                                                                    *
 * Last updated on : 02/09/2023  12:03                                                                                *
 *                                                                                                                    *
...
class Dashboard {
     ...
     *
     */
    public static function instance(string $configuration = null): Dashboard {
     ...
     *
     */
    public function set_current_page_template(): void {
     ...
     */
    public
    function get_template_page(bool $located = false): string {
        if ($located) {
     ...
     */
    public
    function get_current_page_template(): bool|string {
     ...
     */
    public
    static function add_template_to_body_class($list): mixed {
     ...
     */
    public
    static function flush_all(): void {
        $levels = ob_get_level();
        for ($i = 0; $i < $levels; $i++) {
            ob_end_flush();
        }
     ...
     */
    public
    static function load_page(): void {
     ...
     */
    public
    function get_current_located_template(): bool|string {
        return $this->located_template;
    }
     ...
     */
    public
    static function print_head(): void {
        /**
     ...
     */
    public
    static function print_assets_in_header(): void {
        /**
     ...
     */
    public
    function get_user_ip(string $default = null, int $filter_options = 12582912): ?string {
